...
public class BDSimulado {
    ...
    public BDSimulado(){
      ...
      Ligacao l4 = new Ligacao(4, "2345-8945", LocalDateTime.of(2017, 9, 12, 17, 12), LocalDateTime.of(2017, 9, 12, 17, 14), "São Paulo", "SP", c6, 2);
      ...
      Ligacao l6 = new Ligacao(6, "3265-8974", LocalDateTime.of(2017, 9, 12, 19, 21), LocalDateTime.of(2017, 9, 12, 19, 30), "São Paulo", "SP", c3, 9);
      ...
      Ligacao l12 = new Ligacao(12, "2345-8945", LocalDateTime.of(2017, 9, 13, 9, 25), LocalDateTime.of(2017, 9, 13, 10, 15), "São Paulo", "SP", c1,50);
      Ligacao l13 = new Ligacao(13, "1245-7896", LocalDateTime.of(2017, 9, 13, 14, 36), LocalDateTime.of(2017, 9, 13, 15, 55), "São Paulo", "SP", c6, 79);
      Ligacao l14 = new Ligacao(14, "3265-8974", LocalDateTime.of(2017, 9, 13, 20, 01), LocalDateTime.of(2017, 9, 13, 22, 12), "São Paulo", "SP", c2, 131);
      ...
      Ligacao l19 = new Ligacao(19, "4758-6958", LocalDateTime.of(2017, 9, 15, 10, 47), LocalDateTime.of(2017, 9, 15, 11, 03), "São Paulo", "SP", c3,16);
    ...
    //  QUESTÃO 2.a  retorne todas as infor de um cliente fornecido pelo nome
    ...
    //  QUESTÃO 2.b)  retorne o número de ligações realizadas por todos os Clientes de uma determinada UF
    ...
    //  QUESTÃO 2.C)   retorne o número de ligações realizadas por todos os Clientes de uma determinada UF
    ...
    // QUESTÃO 2.d)  retorne uma lista com os códigos de todas as Ligações onde a UF de origem seja diferente da UF de destino.
    ...
    // QUESTÃO 3.a) e tambem a QUESTÃO 3.b
